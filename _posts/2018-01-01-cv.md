...
<li>MKB Bank (>2Y): 4 TSM servers on a HP-UX cluster environment with library manager configuration and other 2 TSM servers (IBM AIX) for document archiving systems</li>
...
<a href="https://www.olimex.com/Products/AVR/Development/AVR-GSM/"><img class="shadow" src="https://www.olimex.com/Products/AVR/Development/AVR-GSM/images/thumbs/310x230/AVR-GSM-01.jpg" alt="" title=""></a><p class="phototext"><a href="https://www.olimex.com/Products/AVR/Development/AVR-GSM/">AVR-GSM</a></p>
</div>
...
<a href="https://www.facebook.com/fleischmann.gy"><i class="icon-facebook" style="margin-left: -5px; margin-right: -6px;"></i>facebook</a> •<a href="https://twitter.com/FleXoft"><i class="icon-twitter" style="margin-right: -1px;"></i>twitter</a> •<a href="https://www.flickr.com/photos/fleischmann/sets/72157622129419487/"><i class="icon-flickr" style="margin-right: -1px;"></i>flickr</a> •<a href="https://plus.google.com/111227740573593478868"><i class="icon-gplus" style="margin-right: 0.3em;"></i>Google+</a> •<a href="http://fleischmann.tumblr.com/"><i class="icon-tumblr" style="margin-left: -4px; margin-right: -4px;"></i>tumblr</a> •<a href="skype://Flexoft/"><i class="icon-skype" style="margin-right: -1px;"></i>Skype</a> • <a href="https://www.linkedin.com/in/fleischmanngyorgy/">linked<i class="icon-linkedin-squared"></i></a>
...
* religion: none (but if I really need to choose: <a href="https://en.wikipedia.org/wiki/Buddhism">Buddhism</a> or <a href="https://en.wikipedia.org/wiki/International_Society_for_Krishna_Consciousness">Krishna Consciousness</a> are the closest)
...
<script type="text/javascript">
    ...
    function dateBirthDiff ( fromDate, toDate ) {
    
        var returnString = "";
        var tmpdiff;
    
        tmpdiff = fromDate.getFullYear() - toDate.getFullYear();
        if ( fromDate.getMonth() - toDate.getMonth() < 0 ) tmpdiff -= 1; 
		if ( tmpdiff != 0 ) {
        	returnString += tmpdiff + " " + ( ( tmpdiff != 1 ) ? "years, " : "year, " );
		}
   	  
   	    tmpdiff = fromDate.getMonth() - toDate.getMonth();
   	 	if ( fromDate.getMonth() - toDate.getMonth() < 0 ) tmpdiff = 12 + ( fromDate.getMonth() - toDate.getMonth() );
   	 	if ( tmpdiff != 0 ) {
     		returnString += tmpdiff + " " + ( ( tmpdiff != 1 ) ? "months" : "month" );
     	}
     	
		if ( tmpdiff != 0 ) returnString += " and "; 

   	    tmpdiff = fromDate.getDate() - toDate.getDate();
   	  	if ( tmpdiff != 0 ) {
   	 	  	returnString += tmpdiff + " " +( ( tmpdiff != 1 ) ? "days" : "day" );
   	  	}
